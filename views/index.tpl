...
<head>
    ...
    <style>
        ...
        .splash-container {height: 100%; background: #467b96;}
...
<body>
    <div class="splash-container">
        <div class="splash" style="height: 95%">
            <h1 class="splash-head"><strong>Typecho</strong> 应用商店</h1>
            ...
            <div class="pure-g">
                <div class="pure-u-1-3">
                    <div class="step-box">
                        <h3>第一步</h3>
                        <p>下载<a href="https://github.com/chekun/AppStore/archive/1.2.0.zip">AppStore插件</a>到usr/plugins/AppStore</p>
                    </div>
                </div>
                <div class="pure-u-1-3">
                    <div class="step-box">
